    ...
    return (
        <div className="flex flex-row h-screen w-screen bg-gradient-to-br from-blue-300 to-purple-500">
            {loading_pag ? (
                ...
                <div className='lg:w-1/3 md:w-1/2 relative bg-gray-100 content-center mx-auto mt-12 mb-12 rounded-xl backdrop-blur-xl backdrop-opacity-10'>
                    <h1 className="text-slate-700 text-4xl font-black text-center mb-2 mt-20"> Sign in</h1>
                    <form className=" flex-col shadow-x bg-gray-100 rounded-xl p-10">
                        ...
                        <div className='p-3 flex justify-center '>
                            <Button variant="bordered" className='w-3/3'>
                                <img
